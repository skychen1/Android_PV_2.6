...
import com.ruihua.libfacerecognitionv3.main.listener.OnImportListener;
import com.ruihua.libfacerecognitionv3.main.manager.ImportFileManager;
...
public class BatchImportActivity extends BaseActivity implements View.OnClickListener, OnImportListener {
    ...
    public void onClick(View view) {
        ...
        } else if (i == R.id.button_import_back) {
            finish();
        }
    }
