...
public class OneFingerDialog2 extends Dialog {

    public OneFingerDialog2(Context context) {
        super(context);
    }

    public OneFingerDialog2(Context context, int theme) {
        super(context, theme);
    }
    ...
    public static class Builder {
        ...
        public OneFingerDialog2 create() {
            LayoutInflater inflater = (LayoutInflater) mContext.getSystemService(
                  Context.LAYOUT_INFLATER_SERVICE);
            final OneFingerDialog2 dialog = new OneFingerDialog2(mContext, R.style.Dialog);
            dialog.setCancelable(false);
            View layout = inflater.inflate(R.layout.dialog_one_finger_layout2, null);
