...
public class CustomNumKeyView2 extends View {
   /**
    * 列
    */
   ...
   public CustomNumKeyView2(Context context, AttributeSet attrs, int defStyle) {
	super(context, attrs, defStyle);
	init(context);

   }

   public CustomNumKeyView2(Context context, AttributeSet attrs) {
	super(context, attrs);
	init(context);

   }

   public CustomNumKeyView2(Context context) {
	super(context);
	init(context);
   }
