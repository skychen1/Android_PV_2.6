...
public class StockMiddleRgAdapter extends BaseQuickAdapter<InventoryVo, BaseViewHolder> {
   ...
   public StockMiddleRgAdapter(int layout, List<InventoryVo> inventoryVos, int size) {
