...
public class HospPopThreeAdapter extends BaseQuickAdapter<HospNameBean.TbaseInfoBean, BaseViewHolder> {

   TextView mMeal;
   TextView mGoneMeal;

   public HospPopThreeAdapter(int layout, List<HospNameBean.TbaseInfoBean> data) {
      super(layout, data);
   }
   ...
   protected void convert(BaseViewHolder helper, HospNameBean.TbaseInfoBean item) {
      ...
      mGoneMeal.setText(item.getDeptCode());
   }
