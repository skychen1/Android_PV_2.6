   ...
   protected void convert(BaseViewHolder helper, SocketLeftTopBean.CstExpirationVosBean item) {
	...
	mStock_card_number.setText(number1);
      ...
      if (number2>0){
	   ...
	   mStock_card_outofdate.setText(Html.fromHtml("<font color='#52C41A'>●&nbsp&nbsp</font>" +"<font color='#333333'>过期耗材：" +  number2 + "个</font>"));
	}
	if (number3>0){
	   ...
	   mStock_card_unexpired.setText(Html.fromHtml("<font color='#52C41A'>●&nbsp&nbsp</font>" +"<font color='#333333'>近效期耗材：" +  number3 + "个</font>"));
