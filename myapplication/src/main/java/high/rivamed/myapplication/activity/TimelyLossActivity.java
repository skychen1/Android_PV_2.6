...
//		   LogUtils.i(TAG,"LAI ");
//		   for (int x =0;x<mTypeView.mTimelyLossAdapter.mLossData.size();x++){
//			if (mTypeView.mTimelyLossAdapter.mLossData.get(x).getRemark()==null||mTypeView.mTimelyLossAdapter.mLossData.get(x).getRemark().equals("")){
//			   LogUtils.i(TAG,"LAI  222");
//			   DialogUtils.showOneDialog(this);
//			   return;
//			}
//		   }
//		   putDate();
